...
<div class="color2">
    ...
    <div class="bandeauImg">
        <img class="" src="images/hardWareBackPetit2.png" style="width:100%" />
    </div>
    ...
    <div class="hardWareBox">
        <div class="hardWareService">
            <div class="clickable" data-toggle="collapse" data-target="#demo">
                <div class="reparation serviceClass">
                </div>
        ...
        <div class="hardWareService">
            <div class="clickable" data-toggle="collapse" data-target="#demo1">
                <div class="optimisation serviceClass">
                </div>
                <div class="hardWareTitre">
                    <h3>Optimisation</h3>
                </div>
        ...
        <div class="hardWareService">
            <div class="clickable" data-toggle="collapse" data-target="#demo2">
                <div class="creation serviceClass">
                </div>
                <div class="hardWareTitre">
                    <h3>Création</h3>
                </div>
...
<div class="color">
    ...
    <div class="bandeauImg">
        <img class="" src="images/cloudBackPetit.png" style="width:100%" />
    </div>    
    
    <p class="prelude">En dehors de l'ordinateur, notre maison est composée de plein d'autres péripheriques, comme les imprimantes, scanner et autre gadgets. Mais encore faut-il savoir les installer et les paramettrer. Et encore, après cela, leur utilité est elle correctement exploitée ? </p>
    <p class="prelude">Aussi, nous avons la chance, d'avoir aujourd'hui, la possibilité de commander une grande panoplie d'objets connectés à partir de notre smartphone ou même de notre voix. Allumer la lumière, éteindre la télévision. Cela nous facilite la vie, mais peut aussi d'être d'un grand secour pour une personne agées tombée et incapable de se relevée seule, par exemple</p>

    <div class="hardWareBox">
        
        <div class="hardWareService">
            <div class="clickable" data-toggle="collapse" data-target="#demo3">
                <div class="assistance serviceClass">
                </div>
                <div class="hardWareTitre">
                    <h3>Assistance à l'installation</h3>
                    <p class="precision">(peripherique/logiciel)</p>
                </div>
            </div>
        ...
        <div class="hardWareService">
            <div class="clickable" data-toggle="collapse" data-target="#demo4">
                <div class="connected serviceClass">
                </div>
                <div class="hardWareTitre">
    ...
    <div class="bandeauImg">
        <img class="" src="images/webDevBackPetit.png" style="width:100%" />
    </div>  
